...
/* malign_mpi_progressive.c */
sint malign_mpi_progressive(sint istart,char *phylip_name);

/* malign_mpi_pdiff.c */
sint malign_mpi_pdiff(sint istart,char *phylip_name);
...
/* prfalign_mpi_progressive.c */
lint prf_init(sint * group, sint * aligned, int which_set, int dest, int reverse_rank);
lint prf_update(int *from_where, int *preverse_rank, int *which_set);

/* prfalign_mpi_pdiff.c: using MPI to do 
...
#define MY_DATA_TAG 2120
#define MY_RESULT_TAG 2121
#define MY_ENDING_TAG 2122
#define MY_BSIZE_TAG 2123

#define PAIRWISE_TAG 3001
#define MALIGN_TAG 3002
#define PREVERSE_TAG 3003

#define MYBSIZE 10240
#define CALLING_STUPID 10241

#define DOING_NJTREE 10242
#define NJTREE_DATA 10243
#define TMAT_ROW_SUM 10244

#define DOING_SHOW_PAIR 10245
#define SHOW_PAIR_DATA 10246
#define SHOW_PAIR_RESULT_SIZE 10247
#define SHOW_PAIR_RESULT 10248
#define WHICH_INTERVAL 10249

/* the larger this macro, the finer grained the parallelization */
#define PAIRALIGN_NCHUNK 100
