...
#AZQMPI_NODES=3 time -p /home/yhb/MPISE_Install/CloudYU/src/MPISE/Release+Asserts/bin/klee -max-time=1800 -lib-MPI -use-directeddfs-search -threaded-all-globals ./kfray.bc -i ../scenes/scenevide.kfr -o aaa10.ppm > kfray_result.ori.log 2>&1 -unsafe
