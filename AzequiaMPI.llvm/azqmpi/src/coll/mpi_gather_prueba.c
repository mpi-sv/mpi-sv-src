...
inline int smp_gather_value(void *sendbuf, int sendcount, MPI_Datatype sendtype,
                            void *recvbuf, int recvcount, MPI_Datatype recvtype,
                            int   root, MPI_Comm comm) 
{
...
inline int smp_gather_reference (void *sendbuf, int sendcount, MPI_Datatype sendtype,
                                 void *recvbuf, int recvcount, MPI_Datatype recvtype,
                                 int   root,    MPI_Comm comm)
{
  int          i;
  ...
  do_bcast(&rootRecvBuff, sizeof(void *), MPI_BYTE, root, comm); 
