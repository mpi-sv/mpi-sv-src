 ...
 *----------------------------------------------------------------*/
    ...
    |    RPQ_create                                                      |
    |                                                                    |
    |    Create a Request Pending Queue                                  |
    |                                                                    |
    |                                                                    |
    |    PARAMETERS:                                                     |
    |    o rpq (Input)                                                   |
    |        The target request pending queue to create                  |
    |    o cmp_fxn (Input)                                               |
    |        Upcall function for comparing requests                      |
    |                                                                    |
     \____________/  ___________________________________________________/
                 / _/
                /_/
               */
#define RPQ_create(rpq, cmp_fxn)                                     \
(                                                                    \
  DLQ_create((rpq), (cmp_fxn))                                       \
)
    ...
    |    RPQ_destroy                                                     |
    |                                                                    |
    |    Free a reuqest pending queue                                    |
    |                                                                    |
    |                                                                    |
    |    PARAMETERS:                                                     |
    |    o rpq (Input)                                                   |
    |        The target request pending queue to free                    |
    |                                                                    |
     \____________/  ___________________________________________________/
                 / _/
                /_/
               */
#define RPQ_destroy(rpq)                                             \
(                                                                    \
  DLQ_destroy((rpq))                                                 \
)
  ...
  DLQ_put((rpq), (rqst))                                             \
    ...
    |                                                                    |
     \____________/  ___________________________________________________/
                ...
                /_/
               */
#define RPQ_get(rpq, rqst, addr, tag, mode)                          \
(                                                                    \
  DLQ_find((rpq), (void **)(rqst), (addr), (tag), 0, (mode))         \
)
