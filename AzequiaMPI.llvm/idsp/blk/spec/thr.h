...
/* Max. number of Thread spawned */
#define MAX_THR_SPAWN     16
...
extern void      THR_setGrpInfo        (Thr_t  thr, void *grpInfo);
extern void      THR_setPlacementInfo  (Thr_t thr, Placement_t place);
extern void      THR_getLocalRank      (Thr_t  thr, int  *localRank); 
extern void      THR_setLocalRank      (Thr_t  thr, int   localRank); 
